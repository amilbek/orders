package com.example.orders.db.filter.enums;
...
public enum Operator {
    ...
    EQUAL {
        public <T> Predicate build(Root<T> root,
                                   CriteriaBuilder cb,
    ...
    BETWEEN {
        public <T> Predicate build(Root<T> root,
            ...
            if (request.getFieldType() == FieldType.DATE) {
                ...
                return cb.and(cb.and(cb.greaterThanOrEqualTo(key, startDate),
                        cb.lessThanOrEqualTo(key, endDate)), predicate);
            }
